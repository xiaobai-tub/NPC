...
@ControllerBind(controllerKey="/authUser",viewPath="/pages")
/*
 * 分享
 * */
public class AuthUserController extends ApiController{
	private static final Logger log = Logger
			.getLogger(AuthUserController.class);
	...
	public void getUserInfo(){
			...
			redirect_url+="?openid="+map.get("openid");
	...
	public void Auth(){
		...
		String url=getPara("url");
		String c=getPara("c");
		String redirect_uri1_0="/onePurchase_wx/authUser/getUserInfo";
