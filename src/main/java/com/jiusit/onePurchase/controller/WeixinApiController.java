...
public class WeixinApiController extends ApiController {
	static Logger logger = Logger.getLogger(WeixinApiController.class);
	...
	public void createMenu() throws Exception{
		//商城
		String redirect_uri1_0=URLEncoder.encode(PropKit.get("host_uri", "setting it in config file")+
				"/onePurchase_wx/home/homePage","utf-8");
		String m1_0="https://open.weixin.qq.com/connect/oauth2/authorize?appid="+getApiConfig().getAppId()+
				"&redirect_uri="+redirect_uri1_0+
				"&response_type=code&scope=snsapi_base&state=defaultToHome#wechat_redirect";
		/*//商城
				String redirect_uri2_0=URLEncoder.encode(PropKit.get("host_uri", "setting it in config file")+
						"/agent/home/homePage","utf-8");
				String m2_0="https://open.weixin.qq.com/connect/oauth2/authorize?appid="+getApiConfig().getAppId()+
						"&redirect_uri="+redirect_uri2_0+
						"&response_type=code&scope=snsapi_base&state=defaultToHome#wechat_redirect";*/
		String str = "{\n" +
				"    \"button\": [\n" +
				"        {\n" +
